...
Partial Class FromFinder
    ...
    End Sub
    Friend Sub New(ByVal entity As String, ByVal capt As String, ByVal keyFields As String(), ByVal ses As acc.Session, ByVal DefaultFilter As String, ByVal iniFilter As String, ByVal Optional multiSelect As Boolean = False)
        InitializeComponent()
    ...
    Private Function FindEx(ByVal entity As String, ByVal filter As XElement, <Out> ByRef xmlData As XElement, ByVal Optional limit As Boolean = True) As String
        ...
        Try
            ...
            wsql += qlf & dfl
            Dim sql As String = Util.GetNativeSQL(entity, fields, limit)
